    ...
    >
      ...
      >
        ...
        >
          ...
          <BottomNavigationAction label="Data Sharing" icon={<ShareIcon />} />
          <BottomNavigationAction label="Activity" icon={<AppleIcon />} />
...
const ProfileTab: React.FC<{ walletInterface: any }> = ({
  walletInterface,
}) => (
  <Box>
